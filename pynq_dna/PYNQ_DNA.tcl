...
#
# PYNQ_DNA.tcl: Tcl script for re-creating project 'DNA_extractor'
#
# Generated by Vivado on Wed Mar 06 11:39:01 EST 2019
...
#
# 1. This project restoration tcl script (PYNQ_DNA.tcl) that was generated.
#
...
#
#    "zynq-dna/pynq_dna/src/design_1.bd"
#    "zynq-dna/pynq_dna/src/design_1_wrapper.v"
#
#*****************************************************************************************
...
set _xil_proj_name_ "DNA_extractor"
...
set orig_proj_dir "[file normalize "$origin_dir/DNA_extractor"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../ip_repo/zynq_AXI_DNA_1.0"]" $obj
...
open_bd_design {./src/design_1.bd}
upgrade_ip [get_ips design_1_zynq_AXI_DNA_0_0]
generate_target all [get_files  ./src/design_1.bd]
export_ip_user_files -of_objects [get_files ./src/design_1.bd] -no_script -force -quiet
